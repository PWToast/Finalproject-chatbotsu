...
def rewrite_query(state: BasicChatState):
    ...
    rewrite_prompt = [
        SystemMessage(content=f"""คุณคือผู้เชี่ยวชาญในการสร้าง 'คำค้นหาภาษาไทย' ที่สมบูรณ์เพื่อใช้ค้นหาในฐานข้อมูล 
โดยพิจารณาจากประวัติการสนทนาล่าสุดและคำถามล่าสุดของผู้ใช้

ประวัติการสนทนา:
{all_conversation}

**คำสั่งที่ต้องปฏิบัติตาม:** 
1.ถ้าคำถามล่าสุดสมบูรณ์อยู่แล้ว ให้ตอบคำถามเดิม
2.ถ้าคำถามล่าสุดมีการใช้คำหรือสรรนาม เช่น "แล้วต้อง", "ที่นั่น", "อันนั้น", "ราคาเท่าไหร่", "กี่วิชา", "กี่หน่วยกิต" ให้สรุปให้เข้าใจว่าผู้ใช้ต้องการจะค้นหาอะไร พอสังเขป
3.ตอบเฉพาะ 'คำค้นหา' ที่ปรับปรุงแล้วเท่านั้น ห้ามอธิบายและห้ามใส่ prefix อื่นๆ"""),
        HumanMessage(content=new_question) # คำถามล่าสุดของผู้ใช้
