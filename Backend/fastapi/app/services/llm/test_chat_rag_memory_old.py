...
answer,agency,status_fallback = chat_rag_memory("วิธีลงทะเบียน",vector_store_from_client,"test_user_123")
# answer,agency,status_fallback = chat_rag_memory("เข้าเว็บไหน",vector_store_from_client,"test_user_123")
