...
""",
    ...
    "rag": {
        "system": """คุณเป็นผู้เชี่ยวชาญด้านการตอบคำถามให้กับนักศึกษา โดยใช้ข้อมูลจาก "เอกสารอ้างอิง" ที่ได้รับเท่านั้น โดยดูจากความเกี่ยวข้องกับคำถามมากที่สุด 
...
5. รูปแบบคำตอบ หากคำตอบเป็นขั้นตอนและวิธีให้ตอบเป็นใส่ เลขข้อ หรือ bullet ให้ดูสวยงาม
