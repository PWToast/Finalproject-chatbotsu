...
- กองบริหารวิชาการ -> ถ้าคำถามเกี่ยวกับ การลงทะเบียน เพิ่มถอนรายวิชา คำร้อง การใช้งานเว็บไซต์ reg ของมหาวิทยาลัยศิลปากร
- สำนักดิจิทัล -> ถ้าคำถามเกี่ยวกับ การใช้งานบริการคอมพิวเตอร์ การใช้งาน SU-IT Account ของมหาวิทยาลัยศิลปากร
...
def llm_decision(state: BasicChatState):
    ...
    """คุณคือผู้เชี่ยวชาญด้านการจัดประเภทคำถามที่เกี่ยวข้องกับ การลงทะเบียน เพิ่มถอนรายวิชา การยื่นขอคำร้อง การใช้งานเว็บไซต์ reg 
    การใช้งานบริการคอมพิวเตอร์ การใช้งาน SU-IT Account กยศ(กู้ยืมเพื่อการศึกษา) หอพักนักศึกษา 
    ...
    2. **general**: ถ้าคำถามล่าสุดเป็นคำถาม 'ทักทาย' หรือ 'พูดคุยทั่วไป' ที่ไม่ต้องการข้อมูลจากฐานความรู้ ซึ่งรวมถึง:
    * คำถามประเภท 'การจัดการบริบท/การทบทวนบทสนทนา' เช่น 'เมื่อกี้ถามอะไรไปบ้าง', 'คุณตอบว่าอะไรนะ'
    3. **other**: เลือกคำนี้ **ถ้าคำถามไม่เข้าข่ายทั้ง 'retrieve' และ 'general' เลย** 
    * คำถามที่ไม่เกี่ยวข้องกับขอบเขตความเชี่ยวชาญ (เช่น เรื่องส่วนตัว, เรื่องนอกประเด็น)
    * คำถามที่กำกวม หรือไม่ชัดเจน
    ---
