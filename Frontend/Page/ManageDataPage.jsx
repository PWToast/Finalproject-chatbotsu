    ...
    <>
      <div className="flex min-h-screen bg-[#E7E9EB]">
        ...
        <main className="m-2 flex-1 overflow-y-auto">
          <div
            className="flex flex-col w-full h-100 items-center border-2 border-dashed"
          ...
          >
            ...
            <p>
              รับขนาดไฟล์รวมกันได้สูงสุด 10MB และไม่เกิน 5
              ไฟล์ต่อครั้งการอัพโหลด
            </p>
            <div
              className="flex flex-row w-32 h-10 bg-amber-300 p-2 rounded-xl mt-5 cursor-pointer hover:bg-amber-600"
