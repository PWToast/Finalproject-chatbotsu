...
function Loginfrom() {
  ...
  async function handleSubmitFrom() {
    ...
    try {
      ...
      if (userRole === "admin") {
        ...
        // เผื่อกรณีมี role อื่นๆ หรือ error ที่ไม่คาดคิด
        console.log("not nevigate");
        navigate("/");
      }
    } catch (error) {
  ...
  return (
    <>
      <span className="text-[50px] self-center absolute pt-20">
        SU Chatbot FAQ
      </span>
        ...
        <div className="h-90 w-100 bg-[#D9D9D9] border border-transparent rounded-xl shadow-xl/30">
          <div className="h-75 flex flex-col justify-between">
            <div className="flex flex-col">
              ...
              />
              <button
                className=" absolute self-end-safe mr-11 mt-38 cursor-pointer"
            ...
            <div className="flex flex-col mb-8 w-100">
              ...
              <div className="flex flex-row gap-2 self-center text-[12px] mt-1">
                ...
                <span className="text-[#007A6D] cursor-pointer hover:text-[#006257]">
